...
from criminal import BaseCriminal, RandomCriminal, ConstrainingCriminal
...
if __name__ == "__main__":
    ...
    criminals = [("Random Criminal #1", RandomCriminal), ("Constraining Criminal #1", ConstrainingCriminal)]
