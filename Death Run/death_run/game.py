...
from criminal import BaseCriminal, RandomCriminal, BoisterousCriminal
...
if __name__ == "__main__":
    ...
    criminals = [("Random Criminal #1", RandomCriminal), ("Boisterous Criminal #1", BoisterousCriminal)]
